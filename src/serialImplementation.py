...
if __name__ == "__main__":
    ...
    # query = "Digital guru floats sub-$100 PC"
    query = "Ink helps drive democracy in Asia"
    print "Query: " + query
    ...
    print retrievePotentialDocuments(query)
    print ""
    ...
    pp.pprint("Scores: " + str(scores))
    pp.pprint("Rank: " + str(ranking(scores, 5)))
    print "Done."
